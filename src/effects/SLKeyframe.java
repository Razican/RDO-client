...
public class SLKeyframe {
	...
	private final Map<SLSide, List<Component>>	cmpsWithStartSide			= new EnumMap<SLSide, List<Component>>(
																			SLSide.class);
	private final Map<SLSide, List<Component>>	cmpsWithEndSide				= new EnumMap<SLSide, List<Component>>(
																			SLSide.class);
	...
	private List<Tile> getTiles(List<Component> cmps,
	Map<Component, Tile> cmpsMap)
	{
